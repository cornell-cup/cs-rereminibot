...
XRP is a modular robotics kit designed for students from age 6 - 18. This repository contains 
a web app for controlling the XRP and sample scripts that allow users to run simple algorithms on their XRP.
