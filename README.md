...
To run the Vision system, run the following commands. You should currently be in the cs-reminibot directory.

Note: Anaconda users should activate the `cup` environment before running.
