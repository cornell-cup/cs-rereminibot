...
class PythonEditor extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (this.props.pythonCode !== nextProps.pythonCode) {
            this.props.setPythonCode(nextProps.pythonCode, this.props.pythonCode);
        }
    }
    ...
    handleFunctionNameChange(event) {
        ...
        if (item != undefined) {
            this.props.setPythonCode(nextProps.pythonCode, item[1]);
        }
